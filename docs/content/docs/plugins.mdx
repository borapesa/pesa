...
The [`@borapesa/devtools`](/docs/api/devtools) package provides developer utilities.
...
<Callout variant="warn">
  This is for **local development only**. Guard it behind `NODE_ENV !== 'production'`. Do not use it in production — webhooks should go directly to your deployed server.
</Callout>
