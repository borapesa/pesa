...
Defined in: [packages/pesa/src/pesa.ts:89](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L89)
...
| ------ | ------ | ------ | ------ |
| <a id="mountwebhook"></a> `mountWebhook` | (`request`) => `Promise`\<`Response`\> | Webhook handler — mount this publicly so providers can POST callbacks. Route: `POST {basePath}/webhook` For order creation and status queries, use [createOrder](#createorder) and [getPaymentStatus](#getpaymentstatus) in your own routes behind your own auth. | [packages/pesa/src/pesa.ts:183](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L183) |
| <a id="provider"></a> `provider` | [`BasePaymentProvider`](../classes/BasePaymentProvider) | The underlying provider adapter. | [packages/pesa/src/pesa.ts:173](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L173) |
...
Defined in: [packages/pesa/src/pesa.ts:150](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L150)
...
Defined in: [packages/pesa/src/pesa.ts:102](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L102)
...
Defined in: [packages/pesa/src/pesa.ts:124](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L124)
...
Defined in: [packages/pesa/src/pesa.ts:156](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L156)
...
Defined in: [packages/pesa/src/pesa.ts:165](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L165)
...
Defined in: [packages/pesa/src/pesa.ts:110](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L110)
...
Defined in: [packages/pesa/src/pesa.ts:132](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L132)
...
Defined in: [packages/pesa/src/pesa.ts:168](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L168)
...
Defined in: [packages/pesa/src/pesa.ts:142](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L142)
...
Defined in: [packages/pesa/src/pesa.ts:162](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L162)
...
Defined in: [packages/pesa/src/pesa.ts:159](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L159)
...
Defined in: [packages/pesa/src/pesa.ts:147](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L147)
...
Defined in: [packages/pesa/src/pesa.ts:153](https://github.com/borapesa/pesa/blob/551532cd94bf0bd50a5389b05b48dbc5bf485d02/packages/pesa/src/pesa.ts#L153)
