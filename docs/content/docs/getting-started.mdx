...
Any class implementing [`PesaDatabaseAdapter`](/docs/api/pesa/interfaces/PesaDatabaseAdapter) works as an event store — use `@borapesa/sqlite`, bring your own PostgreSQL adapter, or swap to Turso. See [Adapters](/docs/adapters) for the full list.
