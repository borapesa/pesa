...
Any class implementing [`PesaDatabaseAdapter`](/docs/api/pesa/interfaces/PesaDatabaseAdapter) works as an event store — use `@borapesa/sqlite`, or implement the four-method interface for your own database. See [Adapters](/docs/adapters) for details.
